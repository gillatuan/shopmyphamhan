...
class ProductController extends FrontendController {
    ...
    public function actionSearch($kw) {
        if ($kw) {
            ...
            $seo = array(
                'keywords'    => Yii::app()->language == 'vi' ? "Tìm kiếm - Từ khóa'{$kw}' " . DEFAULT_META_KEYWORDS . ' voxecu.com' : "product '{$kw}', product '{$kw}' design web, product '{$kw}' voxecu.com",
                'description' => Yii::app()->language == 'vi' ? "Tìm kiếm - Từ khóa '{$kw}' " . DEFAULT_META_DESCRIPTION . ' voxecu.com'  : "product '{$kw}', product '{$kw}' design web, product '{$kw}' voxecu.com",
                'title'       => $pageTitle,
                'type'        => 'Sản phẩm',
                'url'         => Yii::app()->createAbsoluteUrl(Yii::app()->request->requestUri),
                'image'       => '',
    ...
    public function actionListProductsByCategory($cateAlias, $tab = '') {
        ...
        $seo = array(
            'keywords' => Yii::app()->language == 'vi' ? "{$modelCate->description} " . DEFAULT_META_KEYWORDS . 'voxecu.com' : 'homepage, homepage design web, homepage voxecu.com',
            'description' => Yii::app()->language == 'vi' ? "{$modelCate->description} " . DEFAULT_META_DESCRIPTION . ' voxecu.com' : 'homepage, homepage design web, homepage voxecu.com',
            'title' => $pageTitle,
            'type' => 'Sản phẩm',
            'url' => Yii::app()->createAbsoluteUrl(Yii::app()->request->requestUri),
            'image' => '',
    ...
    public function actionView($alias) {
        ...
        $seo = array(
            'keywords'    => Yii::app()->language == 'vi' ? "{$productDetail->name}, {$productDetail->info} " . DEFAULT_META_KEYWORDS . 'voxecu.com' : "{$productDetail->name}, {$productDetail->info}",
            'description' => Yii::app()->language == 'vi' ? "{$productDetail->name}, {$productDetail->info} " . DEFAULT_META_DESCRIPTION . ' voxecu.com'  : "{$productDetail->name}, {$productDetail->info}",
            'title'       => $pageTitle,
            'type'        => 'Sản phẩm',
            'url'         => Yii::app()->createAbsoluteUrl(Yii::app()->request->requestUri),
    ...
    public function actionViewCart() {
        ...
        if (Helper::post('User')) {
            ...
            if ($model->save()) {
                ...
                $params = array(
                    ...
                    'subject'  => 'Voxecu.com Member Registration Confirmation',
                    'body'     => array(
                    ...
                    'mailTo'   => $model->email,
		    'mailFrom' => array(ADMIN_EMAIL => 'Voxecu.com - ' .ADMIN_EMAIL )
                );
                // send
        ...
        $seo = array(
            'keywords'    => Yii::app()->language == 'vi' ? "giỏ hàng của bạn, thông tin giỏ hàng " . DEFAULT_META_KEYWORDS . 'voxecu.com' : "your card, your cart info",
            'description' => Yii::app()->language == 'vi' ? "giỏ hàng của bạn, thông tin giỏ hàng " . DEFAULT_META_DESCRIPTION . ' voxecu.com' : "your card, your cart info",
            'title'       => $pageTitle,
            'type'        => 'Sản phẩm',
            'url'         => Yii::app()->createAbsoluteUrl(Yii::app()->request->requestUri),
            'image'       => '',
    ...
    public function actionConfirmOrder() {
        ...
        if (Helper::post('confirmOrder')) {
            ...
            $params = array(
                ...
                'subject'  => 'Voxecu.com - Đơn đặt hàng',
                'body'     => array(
                    'billTo'   => $billTo,
                    'shipTo'   => $shipTo,
                    'userCart' => $cart,
                ...
                'mailTo'   => $billTo['email'],
                'mailFrom' => array(ADMIN_EMAIL => 'Vỏ xe cũ - ' . ADMIN_EMAIL)
            );
            // send
            Helper::sendMail($params);
            // remove Cart
        ...
        $seo = array(
            'keywords'    => Yii::app()->language == 'vi' ? "xác nhận đơn hàng, xác nhân đơn hàng của bạn " . DEFAULT_META_KEYWORDS . 'voxecu.com' : "confirm your order",
            'description' => Yii::app()->language == 'vi' ? "xác nhận đơn hàng, xác nhân đơn hàng của bạn " . DEFAULT_META_DESCRIPTION . ' voxecu.com' : "confirm your order",
            'title'       => $pageTitle,
            'type'        => 'Sản phẩm',
            'url'         => Yii::app()->createAbsoluteUrl(Yii::app()->request->requestUri),
            'image'       => '',
    ...
    public function actionReadNews($newsAlias) {
        ...
        $seo = array(
            'keywords'    => Yii::app()->language == 'vi' ? "$news->title, $typeNews $news->title " . DEFAULT_META_KEYWORDS . 'voxecu.com' : "$news->title, $typeNews $news->title",
            'description' => Yii::app()->language == 'vi' ? "$news->title, $typeNews $news->title " . DEFAULT_META_DESCRIPTION . ' voxecu.com' : "$news->title, $typeNews $news->title",
            'title'       => $pageTitle,
            'type'        => 'Tin Tức',
            'url'         => Yii::app()->createAbsoluteUrl(Yii::app()->request->requestUri),
            'image'       => '',
    ...
    public function actionFAQ() {
        ...
        $seo = array(
            'keywords'    => Yii::app()->language == 'vi' ? "Hỏi đáp, đặt câu hỏi, những vấn đề liên quan đến shop của chúng tôi " . DEFAULT_META_KEYWORDS . 'voxecu.com' : "FAQ, send your question, regarding to our shop",
            'description' => Yii::app()->language == 'vi' ? "Hỏi đáp, đặt câu hỏi, những vấn đề liên quan đến shop của chúng tôi " . DEFAULT_META_DESCRIPTION . ' voxecu.com' : "FAQ, send your question, regarding to our shop",
            'title'       => $pageTitle,
            'type'        => 'FAQ',
            'url'         => Yii::app()->createAbsoluteUrl(Yii::app()->request->requestUri),
            'image'       => '',
