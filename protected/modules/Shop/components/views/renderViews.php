...
<?php $notMargin = $index == 0 || $index == 1 ? 'not-margin-top' : ''; ?>
    <?php if (in_array(intval($isOnIndex), $data->page)) { ?>
    <div class="comment <?php echo $notMargin; ?> sixcol <?php echo $last; ?>">
        <h3><a href="<?php echo Helper::url('/Shop/product/view', array('cateAlias' => $data)) ?>"><?php echo $data->subject; ?></a></h3>
        <div class="rated">
...
<?php }} else { ?>
    ...
    <img src="/uploads/avatar.jpg" alt="<?php echo $data->full_name; ?>" />
