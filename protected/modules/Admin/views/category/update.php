...
<?php if (!Helper::user()->checkAccess('Super')) { ?>
    <div class="content-box-header">
        <h3><?php echo !$model->isNewRecord ? 'Cập nhật Chuyên mục -  ' . $model->name : "Tạo mới Chuyên mục";
            ?></h3>
...
<?php } else { ?>
    ...
    <div class="portlet-title">
        <h4>
            ...
            <?php echo !$model->isNewRecord ? 'Cập nhật Chuyên mục -  ' . $model->name : "Tạo mới Chuyên mục"; ?>
        </h4>
