...
/* @var $this Nhận xétController */
/* @var $model Nhận xét */
$this->breadcrumbs = array(
    'Nhận xét'   => array('index'),
    $model->subject => array(
        'view',
        'id' => $model->id
    ),
...
<?php if (!Helper::user()->checkAccess('Super')) { ?>
    <div class="content-box-header">
        <h3><?php echo !$model->isNewRecord ? 'Cập nhật Nhận xét -  ' . $model->subject : "Tạo mới Nhận xét";
            ?></h3>
...
<?php } else { ?>
    ...
    <div class="portlet-title">
        <h4>
            ...
            <?php echo !$model->isNewRecord ? 'Cập nhật Nhận xét -  ' . $model->subject : "Tạo mới Nhận xét"; ?>
        </h4>
