...
class SettingParams extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array(
                ...
                'name, label', 'length', 'max' => 64
            ), array(
                'visible', 'length', 'max' => 1
            ), array(
                'values, description', 'safe'
            ), // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array(
                'id, name, label, values, description, visible', 'safe', 'on' => 'search'
            ),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            'id'          => 'ID', 'name' => Helper::t('name'), 'label' => Helper::t('label'), 'values' => Helper::t('values'),
            'description' => Helper::t('description'), 'ordering' => Helper::t('Sắp xếp'), 'visible' => Helper::t('Kích hoạt'),
        );
    }
