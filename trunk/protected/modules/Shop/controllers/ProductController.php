...
class ProductController extends FrontendController {
    public $includeText = 'Shop Phái Đẹp Online | ';
        ...
        if (Helper::post('User')) {
            ...
            if ($model->save()) {
                ...
                $params = array(
                    ...
                    'subject'  => 'shopphaideponline.com Member Registration Confirmation',
                    'body'     => array(
                    ...
                    'mailTo'   => $model->email,
		    'mailFrom' => array(ADMIN_EMAIL => 'shopphaideponline.com - ' .ADMIN_EMAIL )
                );
                // send
    ...
    public function actionConfirmOrder() {
        ...
        if (Helper::post('confirmOrder')) {
            ...
            $params = array(
                ...
                'subject'  => 'shopphaideponline.com - Đơn đặt hàng',
                'body'     => array(
                    'billTo'   => $billTo,
                    'shipTo'   => $shipTo,
                    'userCart' => $cart,
                ...
                'mailTo'   => $billTo['email'],
                'mailFrom' => array(ADMIN_EMAIL => 'Shop Phái Đẹp Online - ' . ADMIN_EMAIL)
            );
            // send
            Helper::sendMail($params);
            // remove Cart
