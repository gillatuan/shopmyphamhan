...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'page_link'); ?>
		<?php echo $form->textField($model,'page_link',array('size'=>60,'maxlength'=>255)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'page',array('size'=>1,'maxlength'=>1)); ?>
	</div>
