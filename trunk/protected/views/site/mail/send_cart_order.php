<style type="text/css">
    ...
    <div class="normal">
        ...
        <div class="contact">
            ...
            <p class="detail">ĐT: <?php echo HOTLINE; ?></p>
            <p class="detail">Website: <a href="<?php echo Helper::url('/Shop/product/index'); ?>" title="Shop Mỹ Phẩm Hàn">http://shopmyphamhan.com</a></p>
        </div>
    </div>
